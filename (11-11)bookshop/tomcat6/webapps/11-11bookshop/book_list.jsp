...
<div class="main_clearfix">
        ...
        <div class="box_serach_bot">
            ...
            <div class="box_serach_bot_info" style="display: block;margin:auto;" >
            	...
            	<a id="box_serach_bot_info_title_all" class="box_serach_bot_info_title_all" onclick="click_more()">点击查看更多</a>
...
<input type="hidden" value="<%=request.getParameter("key") %>" id="key">
<input type="hidden" value="<%=request.getParameter("key-value") %>" id="value">
</body>
</html>
