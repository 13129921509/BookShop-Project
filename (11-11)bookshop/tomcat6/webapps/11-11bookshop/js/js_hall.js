...
function click_more() {
	...
	//
	//console.log(sousuoapp.canshu.keys);
		...
		$.ajax({
			...
			{	
				...
				for(var i = 0;i < list.length ;i++){
					...
					weapp.dom_child.href = "view.jsp?index="+list[i]['bookId'];//"show/"+ list[i]["bookId"]+".action";
...
$(document).ready(function() {
	...
	var scheduleBox4 = document.querySelector('#box_serach_bot_info_title_all');
	document.addEventListener("click", function(e){
		console.log(e.target);
	     ...
	     if(e.target !== scheduleBox2&&e.target !== scheduleBox3&&e.target !== scheduleBox4){
